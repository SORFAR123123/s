...
const rpgNovia = {
    ...
    usarMomentoIntimo: function(momentoId) {
        ...
        if (!this.estado.humorActual.permiteIntimos) {
            mostrarMensessage(`${this.estado.nombreNovia} está ${this.estado.humorActual.nombre} y no está de humor para momentos íntimos 💔`);
            return false;
        }
        ...
        mostrarMensessage(`💖 Momento íntimo especial: ${momento.nombre} (+${expGanada} XP)`);
        return true;
    },
...
// ============================================================================
// FUNCIONES DEL SISTEMA DE PALABRAS FALLADAS - NUEVAS
// ============================================================================
